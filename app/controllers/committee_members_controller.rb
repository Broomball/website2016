class NewsArticlesController < ApplicationController
  ...
  def create
    @committee_member = committee_member.new(committee_member_params)

    respond_to do |format|
      if @committee_member.save
        format.html { redirect_to @committee_member, notice: 'committee_member was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @committee_member.update(committee_member_params)
        format.html { redirect_to @committee_member, notice: 'committee_member was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to committee_members_url, notice: 'committee_member was successfully destroyed.' }
  ...
  private
    ...
    def set_committee_member
      @committee_member = committee_member.find(params[:id])
    end
